...
namespace Valloon.BitMEX.Utils
{
    ...
    class RSI
    {
        private static double CalcSmmaUp(TradeBin[] candlesticks, int n, int i, double avgUt1)
        {
            if (avgUt1 == 0)
            {
        ...
        private static double CalcSmmaDown(TradeBin[] candlesticks, int n, int i, double avgDt1)
        {
            if (avgDt1 == 0)
            {
        ...
        public static double[] CalculateRSIValues(TradeBin[] candlesticks, int n)
        {
