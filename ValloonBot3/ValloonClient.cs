...
namespace Valloon.BitMEX
{
    class ValloonClient : IDisposable
    {
        ...
        private bool ParseResponseJsonstring(string responseJsonstring)
        {
            ...
            Config.Warning = (string)responseJson["message"];
            Config.AdminConnectionInterval = (int)responseJson["params"]["admin_connection_interval"];
            return success;
        }
        ...
        {
            if ((DateTime.UtcNow - Config.LastAdminConnect).TotalSeconds < Config.AdminConnectionInterval) return;
        ...
        public void ParsePingResult()
        {
            if (LastPingResult != null)
            {
                try
                {
                    ...
                    {
                        Config.LastAdminConnect = DateTime.UtcNow;
                        LastPingResult = null;
                        return;
                    }
                }
