...
namespace IO.Swagger.Model
{
    ...
    public partial class Position : IEquatable<Position>, IValidatableObject
    {
        ...
        public Position(decimal? account = default, string symbol = default, string currency = default, string underlying = default, string quoteCurrency = default, double? commission = 0.0, double? initMarginReq = 0.0, double? maintMarginReq = 0.0, decimal? riskLimit = default, double? leverage = 0.0, bool? crossMargin = default, double? deleveragePercentile = 0.0, decimal? rebalancedPnl = default, decimal? prevRealisedPnl = default, decimal? prevUnrealisedPnl = default, double? prevClosePrice = 0.0, DateTime? openingTimestamp = default, decimal? openingQty = default, decimal? openingCost = default, decimal? openingComm = default, decimal? openOrderBuyQty = default, decimal? openOrderBuyCost = default, decimal? openOrderBuyPremium = default, decimal? openOrderSellQty = default, decimal? openOrderSellCost = default, decimal? openOrderSellPremium = default, decimal? execBuyQty = default, decimal? execBuyCost = default, decimal? execSellQty = default, decimal? execSellCost = default, decimal? execQty = default, decimal? execCost = default, decimal? execComm = default, DateTime? currentTimestamp = default, int? currentQty = default, decimal? currentCost = default, decimal? currentComm = default, decimal? realisedCost = default, decimal? unrealisedCost = default, decimal? grossOpenCost = default, decimal? grossOpenPremium = default, decimal? grossExecCost = default, bool? isOpen = default, decimal? markPrice = 0, decimal? markValue = default, decimal? riskValue = default, double? homeNotional = 0.0, double? foreignNotional = 0.0, string posState = default, decimal? posCost = default, decimal? posCost2 = default, decimal? posCross = default, decimal? posInit = default, decimal? posComm = default, decimal? posLoss = default, decimal? posMargin = default, decimal? posMaint = default, decimal? posAllowance = default, decimal? taxableMargin = default, decimal? initMargin = default, decimal? maintMargin = default, decimal? sessionMargin = default, decimal? targetExcessMargin = default, decimal? varMargin = default, decimal? realisedGrossPnl = default, decimal? realisedTax = default, decimal? realisedPnl = default, decimal? unrealisedGrossPnl = default, decimal? longBankrupt = default, decimal? shortBankrupt = default, decimal? taxBase = default, double? indicativeTaxRate = 0.0, decimal? indicativeTax = default, decimal? unrealisedTax = default, decimal? unrealisedPnl = default, double? unrealisedPnlPcnt = 0.0, double? unrealisedRoePcnt = 0.0, double? simpleQty = 0.0, double? simpleCost = 0.0, double? simpleValue = 0.0, double? simplePnl = 0.0, double? simplePnlPcnt = 0.0, decimal? avgCostPrice = 0, decimal? avgEntryPrice = 0, double? breakEvenPrice = 0.0, double? marginCallPrice = 0.0, decimal? liquidationPrice = 0, double? bankruptPrice = 0.0, DateTime? timestamp = default, decimal? lastPrice = 0, decimal? lastValue = default)
        {
