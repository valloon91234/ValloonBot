...
namespace IO.Swagger.Model
{
    ...
    public partial class Order : IEquatable<Order>, IValidatableObject
    {
        ...
        public Order(string orderID = default, string clOrdID = default, string clOrdLinkID = default, decimal? account = default, string symbol = default, string side = default, decimal? simpleOrderQty = default, int? orderQty = default, decimal? price = default, decimal? displayQty = default, decimal? stopPx = default, double? pegOffsetValue = default, string pegPriceType = default, string currency = default, string settlCurrency = default, string ordType = default, string timeInForce = default, string execInst = default, string contingencyType = default, string exDestination = default, string ordStatus = default, string triggered = default, bool? workingIndicator = default(bool?), string ordRejReason = default, decimal? simpleLeavesQty = default, decimal? leavesQty = default, double? simpleCumQty = default, decimal? cumQty = default, decimal? avgPx = default, string multiLegReportingType = default, string text = default, DateTime? transactTime = default, DateTime? timestamp = default)
        {
