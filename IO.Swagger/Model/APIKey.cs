...
namespace IO.Swagger.Model
{
    ...
    public partial class APIKey :  IEquatable<APIKey>, IValidatableObject
    {
        ...
        public APIKey(string id = default(string), string secret = default(string), string name = default(string), decimal? nonce = default(decimal?), string cidr = default(string), List<string> permissions = default(List<string>), bool? enabled = false, decimal? userId = default(decimal?), DateTime? created = default(DateTime?))
        {
