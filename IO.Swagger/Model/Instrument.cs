...
namespace IO.Swagger.Model
{
    ...
    public partial class Instrument :  IEquatable<Instrument>, IValidatableObject
    {
        ...
        public Instrument(string symbol = default, string rootSymbol = default, string state = default, string typ = default, DateTime? listing = default, DateTime? front = default, DateTime? expiry = default, DateTime? settle = default, DateTime? relistInterval = default, string inverseLeg = default, string sellLeg = default, string buyLeg = default, double? optionStrikePcnt = default, double? optionStrikeRound = default, double? optionStrikePrice = default, double? optionMultiplier = default, string positionCurrency = default, string underlying = default, string quoteCurrency = default, string underlyingSymbol = default, string reference = default, string referenceSymbol = default, DateTime? calcInterval = default, DateTime? publishInterval = default, DateTime? publishTime = default, decimal? maxOrderQty = default(decimal?), double? maxPrice = default, decimal? lotSize = default(decimal?), double? tickSize = default, decimal? multiplier = default(decimal?), string settlCurrency = default, decimal? underlyingToPositionMultiplier = default(decimal?), decimal? underlyingToSettleMultiplier = default(decimal?), decimal? quoteToSettleMultiplier = default(decimal?), bool? isQuanto = default, bool? isInverse = default, double? initMargin = default, double? maintMargin = default, decimal? riskLimit = default(decimal?), decimal? riskStep = default(decimal?), double? limit = default, bool? capped = default, bool? taxed = default, bool? deleverage = default, double? makerFee = default, double? takerFee = default, double? settlementFee = default, double? insuranceFee = default, string fundingBaseSymbol = default, string fundingQuoteSymbol = default, string fundingPremiumSymbol = default, DateTime? fundingTimestamp = default, DateTime? fundingInterval = default, double? fundingRate = default, double? indicativeFundingRate = default, DateTime? rebalanceTimestamp = default, DateTime? rebalanceInterval = default, DateTime? openingTimestamp = default, DateTime? closingTimestamp = default, DateTime? sessionInterval = default, double? prevClosePrice = default, double? limitDownPrice = default, double? limitUpPrice = default, double? bankruptLimitDownPrice = default, double? bankruptLimitUpPrice = default, decimal? prevTotalVolume = default(decimal?), decimal? totalVolume = default(decimal?), decimal? volume = default(decimal?), decimal? volume24h = default(decimal?), decimal? prevTotalTurnover = default(decimal?), decimal? totalTurnover = default(decimal?), decimal? turnover = default(decimal?), decimal? turnover24h = default(decimal?), double? homeNotional24h = default, double? foreignNotional24h = default, double? prevPrice24h = default, double? vwap = default, double? highPrice = default, double? lowPrice = default, decimal? lastPrice = default, double? lastPriceProtected = default, string lastTickDirection = default, double? lastChangePcnt = default, double? bidPrice = default, double? midPrice = default, double? askPrice = default, double? impactBidPrice = default, double? impactMidPrice = default, double? impactAskPrice = default, bool? hasLiquidity = default, decimal? openInterest = default(decimal?), decimal? openValue = default(decimal?), string fairMethod = default, double? fairBasisRate = default, double? fairBasis = default, double? fairPrice = default, string markMethod = default, decimal? markPrice = default, double? indicativeTaxRate = default, double? indicativeSettlePrice = default, double? optionUnderlyingPrice = default, double? settledPrice = default, DateTime? timestamp = default)
        {
