...
namespace IO.Swagger.Model
{
    ...
    public partial class TradeBin :  IEquatable<TradeBin>, IValidatableObject
    {
        ...
        public TradeBin(DateTime? timestamp = default(DateTime?), string symbol = default(string), decimal? open = default(decimal?), decimal? high = default(decimal?), decimal? low = default(decimal?), decimal? close = default(decimal?), decimal? trades = default(decimal?), decimal? volume = default(decimal?), decimal? vwap = default(decimal?), decimal? lastSize = default(decimal?), decimal? turnover = default(decimal?), decimal? homeNotional = default(decimal?), decimal? foreignNotional = default(decimal?))
        {
